...
public class GradeInputs extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try{
            ...
            if(userint==0){
                JOptionPane.showMessageDialog(null,"How can you have 0 assingmnents dummy!!!");
                return;
            }
        ...
        }catch(NumberFormatException POWER){
    ...
    private JPanel createMainPanel(final int userint){
        ...
        final JTextField[] markTextFields = new JTextField[userint]; //Holds individual data. Size depends on the number of assignments.
        final JTextField[] weightTextFields = new JTextField[userint];
        ...
        savebutton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < userint; i++) {
                    ...
                    }catch(NumberFormatException elephanteyes){
                        JOptionPane.showMessageDialog(null,"Please fill all fields with non-negative Integers!");
                        return;
                    }

                }
                savebutton.addActionListener(new Save(finalScore));
        ...
        computebutton.addActionListener(new ActionListener() {
                                            ...
                                            @Override
                                            //This is were the magic happens. All of the TextFields are iterated through and finalScore gets updated.
                                            public void actionPerformed(ActionEvent e) {
                                                double finalScore = 0;
                                                for (int i = 0; i < userint; i++) {
                                                    try {
                                                        ...
                                                        finalScore += weight / 100 * mark;
                                                    }catch(NumberFormatException love){
                                                        JOptionPane.showMessageDialog(null,"Please fill all fields with non-negative Integers!");
                                                        return;
                                                    }
                                                }
